...
public class PeriodFormatterBuilder {
    ...
    private void clearPrefix() throws IllegalStateException {
        if (iPrefix != null)
        {
            throw new IllegalStateException("Prefix not followed by misc.field");
        }
    ...
    private PeriodFormatterBuilder appendSuffix(PeriodFieldAffix suffix) {
        ...
        {
            throw new IllegalStateException("No misc.field to apply suffix to");
        }
    ...
    static class FieldFormatter implements PeriodPrinter, PeriodParser {
        ...
        public int parseInto(ReadWritablePeriod period, String text, int position, Locale locale) {
            ...
            if (iPrefix != null)
            {
                ...
                else
                {
                    ...
                    if (!mustParse)
                    {
                        // It's okay because parsing of this misc.field is not
            ...
            {
                // Pre-scan the suffix, to help determine if this misc.field must be
                // parsed.
            ...
            {
                // If parsing is not required and the misc.field is not supported,
            ...
            if (suffixPos >= 0 && position + length != suffixPos)
            {
                ...
                // to a misc.field not yet reached. Return original position so that
        ...
        long getFieldValue(ReadablePeriod period) {
            ...
            // determine if misc.period is zero and this is the last misc.field
            if (value == 0)
            {
