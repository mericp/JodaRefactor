...
public final class ZonedChronology extends AssembledChronology {
    ...
    public static ZonedChronology getInstance(Chronology base, DateTimeZone zone) {
        if (base == null)
        {
            throw new IllegalArgumentException("Must supply a misc.chronology");
        }
        ...
        if (base == null)
        {
            throw new IllegalArgumentException("UTC misc.chronology must not be null");
        }
    ...
    protected void assemble(Fields fields) {
        // Keep a misc.local cache of converted fields so as not to create redundant
        // objects.
        HashMap<Object, Object> converted = new HashMap<>();

        // Convert misc.duration fields...
    ...
    static final class ZonedDateTimeField extends BaseDateTimeField {
        ...
        public long set(long instant, int value) {
            ...
            if (get(result) != value) {
                ...
                IllegalFieldValueException ex = new IllegalFieldValueException(iField.getType(), value, cause.getMessage());
                ex.initCause(cause);
                throw ex;
            }
            return result;
