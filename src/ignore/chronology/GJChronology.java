...
public final class GJChronology extends AssembledChronology {
    ...
    protected void assemble(Fields fields) {
        ...
        // Compute difference between the chronologies at the cutover misc.instant
        iGapDuration = iCutoverMillis - julianToGregorianByYear(iCutoverMillis);

        // Begin misc.field definitions.
    ...
    private class CutoverField extends BaseDateTimeField {
        ...
        CutoverField(DateTimeField julianField, DateTimeField gregorianField, DurationField rangeField, long cutoverMillis, boolean convertByWeekyear) {
            ...
            // use the Gregorian misc.duration misc.field because it is more accurate.
        ...
        public int getMinimumValue(long instant) {
            ...
            // Because the cutover may reduce the length of this misc.field, verify
        ...
        public long set(long instant, int value) {
            if (instant >= iCutover) {
                ...
                if (instant < iCutover) {
                    ...
                    if (get(instant) != value) {
                        throw new IllegalFieldValueException
                            (iGregorianField.getType(), value, null, null);
                    }
                }
            } else {
                ...
                if (instant >= iCutover) {
                    ...
                    if (get(instant) != value) {
                       throw new IllegalFieldValueException
                            (iJulianField.getType(), value, null, null);
                    }
                }
            }
            return instant;
