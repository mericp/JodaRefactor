...
public abstract class DateTimeZone implements Serializable {
    ...
    private static Provider getDefaultProvider() {
        ...
        try
        {
            String providerClass = System.getProperty("misc.datetime.DateTimeZone.Provider");
    ...
    public static void setDefault(DateTimeZone zone) throws SecurityException {
        ...
        if (zone == null)
        {
            throw new IllegalArgumentException("The misc.datetime zone must not be null");
        }
    ...
    public static DateTimeZone forID(String id) {
        ...
        throw new IllegalArgumentException("The misc.datetime zone id '" + id + "' is not recognised");
    }
            ...
            if (strict || offsetLocal < 0)
            {
                ...
                if (nextLocal != nextAdjusted)
                {
                    ...
                    else
                    {
                        ...
                        // the offset is wrong and will result in misc.local times
    ...
    public long adjustOffset(long instant, boolean earlierOrLater) {
        ...
        // work out range of instants that have duplicate misc.local times
