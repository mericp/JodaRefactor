...
public final class DateTime extends BaseDateTime implements ReadableDateTime, Serializable {
    ...
    public DateTime withEarlierOffsetAtOverlap() {
        long newMillis = getTimeZone().adjustOffset(getMillis(), false);
        return withMillis(newMillis);
    }
    public DateTime withLaterOffsetAtOverlap() {
        long newMillis = getTimeZone().adjustOffset(getMillis(), true);
        return withMillis(newMillis);
    }
    ...
    public DateTime withTimeAtStartOfDay() {
        return toLocalDate().toDateTimeAtStartOfDay(getTimeZone());
    }
